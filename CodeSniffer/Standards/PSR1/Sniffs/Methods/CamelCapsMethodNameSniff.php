...
if (class_exists('DM_Sniffs_NamingConventions_CamelCapsFunctionNameSniff', true) === false) {
    throw new PHP_CodeSniffer_Exception('Class DM_Sniffs_NamingConventions_CamelCapsFunctionNameSniff not found');
}
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class PSR1_Sniffs_Methods_CamelCapsMethodNameSniff extends DM_Sniffs_NamingConventions_CamelCapsFunctionNameSniff
{
