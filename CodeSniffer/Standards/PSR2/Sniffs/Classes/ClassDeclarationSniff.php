...
if (class_exists('DM_Sniffs_Classes_ClassDeclarationSniff', true) === false) {
    $error = 'Class DM_Sniffs_Classes_ClassDeclarationSniff not found';
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class PSR2_Sniffs_Classes_ClassDeclarationSniff extends DM_Sniffs_Classes_ClassDeclarationSniff
{
