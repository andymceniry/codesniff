<?php
/**
 * DM_Sniffs_Functions_MultiLineFunctionDeclarationSniff.
 *
 * PHP version 5
 *
 * @category  PHP
...
if (class_exists('DM_Sniffs_Functions_FunctionDeclarationSniff', true) === false) {
    $error = 'Class DM_Sniffs_Functions_FunctionDeclarationSniff not found';
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class DM_Sniffs_Functions_MultiLineFunctionDeclarationSniff extends DM_Sniffs_Functions_FunctionDeclarationSniff
{
